...
<img src="/img/chromatogrampng" alt="A chromatogram, illustrating the total amount of analytes over the retention time" width="100%" />
...
<img src="/img/SchematicMS2png" alt="Schematics of a mass spectrometer and two rounds of MS" width="100%" />
...
<img src="/img/mstutgif" alt="Separation and detection of ions in a mass spectrometer" width="100%" />
...
<img src="/img/MS1-MS2-spectrapng" alt="Parent ions in the MS1 spectrum (left) and two sected fragment ions MS2 spectra (right)" width="100%" />
...
<img src="/img/F02-3D-MS1-scans-400-1200-latticepng" alt="MS1 spectra over retention time" width="100%" />
<p class="caption">MS1 spectra over retention time</p>

<img src="/img/F02-3D-MS1-MS2-scans-100-1200-latticepng" alt="MS2 spectra interleaved between two MS1 spectra" width="100%" />
