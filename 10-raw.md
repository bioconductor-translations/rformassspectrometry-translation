...
-   `MsBackendDataFrame`: the mass spectrometry data is stored
...
-   `filterAcquisitionNum`: retain spectra with certain acquisition
    numbers.
...
Most functions on `Spectra` support (and use) parallel processing out of
